...
const typeDescriptions = {
  rule: '안전 규정은 단순한 권고가 아니라, 생명과 직결된 약속 입니다.\n\n 그러나 반복되는 무시와 방심은 결국 큰 참사로 이어졌습니다. 이 영역에서는 "안전 규정 위반"이 주요 원인이 된 국내외 사고들을 모아 보여줍니다. 작은 경고를 가벼이 여기지 않는 문화, 그 시작을 위해 기억 합니다.',
  build:
